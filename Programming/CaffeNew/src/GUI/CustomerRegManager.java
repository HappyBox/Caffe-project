...
public class CustomerRegManager extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CustomerRegManager(Manager Mngr, CtrTable ctrTable) {
		setTitle("Logged in as " + Mngr.getName());
		...
		btnContinue.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					{
						Table table = new Table(Mngr, cus, ctrTable);
